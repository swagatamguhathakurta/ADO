...
#define RC_MAX_FILE_HANDLE_OPEN 600
#define RC_FILE_CREATE_FAILED 601
#define RC_FILE_HANDLE_IN_USE 602
#define RC_FILE_DESTROY_FAILED 603
#define RC_FILE_CLOSE_FAILED 604
#define RC_READ_FAILED 605
